...
Rails.application.routes.draw do
  ...
  devise_scope :user do
    ...
    namespace :auth do
      ...
      # Multi-account switching (browser-bound account ring)
      post   'accounts/switch', to: 'account_sessions#switch',     as: :switch_account
      delete 'accounts/all',    to: 'account_sessions#remove_all', as: :remove_all_accounts
      delete 'accounts/:id',    to: 'account_sessions#remove',     as: :remove_account
    end
  end

...
ActiveRecord::Schema[8.1].define(version: 2026_06_26_120000) do
  ...
  create_table "room_memberships", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_room_memberships_on_account_id"
    t.index ["room_id", "account_id"], name: "index_room_memberships_on_room_id_and_account_id", unique: true
  ...
  create_table "statuses", id: :bigint, default: -> { "timestamp_id('statuses'::text)" }, force: :cascade do |t|
    ...
    t.index ["room_id", "id"], name: "index_statuses_on_room_id_and_id", order: { id: :desc }, where: "(room_id IS NOT NULL)"
  ...
  add_foreign_key "room_memberships", "accounts", on_delete: :cascade
  add_foreign_key "room_memberships", "rooms", on_delete: :cascade
  add_foreign_key "rooms", "accounts", on_delete: :cascade

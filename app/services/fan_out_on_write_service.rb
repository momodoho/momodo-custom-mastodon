...
class FanOutOnWriteService < BaseService
  ...
  def broadcastable?
    # momodo: this closed community posts unlisted by default (public posting is
    # disabled) and surfaces unlisted statuses in the public ("퍼블릭 모아보기")
    # feed, so unlisted must also broadcast to the public streams to update live.

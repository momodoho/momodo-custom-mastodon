...
class PublicFeed
  ...
  def public_scope
    # momodo: closed community has no public posts, so local/public timelines
    # surface unlisted statuses instead.
    Status.unlisted_visibility.joins(:account).merge(Account.without_suspended.without_silenced)
  end

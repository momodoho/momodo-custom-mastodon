...
class Form::AdminSettings
  ...
  # momodo: admin brand image uploads, per theme (마스토돈 = default / 트위터 =
  # birdui) × color scheme (light/dark) — e.g. logo_birdui_dark (12 total).
  BRAND_UPLOAD_KEYS = %w(logo login_bg app_bg).product(%w(default birdui), %w(light dark)).map do |asset, theme, scheme|

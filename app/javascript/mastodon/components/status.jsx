...
class Status extends ImmutablePureComponent {
  ...
  _openStatus = (newTab = false) => {
    // momodo: room (group message) posts have no detail view — clicking a message
    // must not open the status (which would expose reply/boost). Block navigation.
    if (this._properStatus().get('room_id')) {
      return;
    }

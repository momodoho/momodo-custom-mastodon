...
class REST::StatusSerializer < ActiveModel::Serializer
  ...
  # momodo: lets the client know a status belongs to a room (group message) so it
  # can hide reply/boost actions. Only present for room posts.
  attribute :room_id, if: :room?
